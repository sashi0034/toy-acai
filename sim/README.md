...
加えて各 Blue 機体に、場外に出ている間の本人ペナルティ、近くの敵ミサイルが自機へ向かっているときの本人ペナルティ、直前観測で射界内に生存 Red がいる状態で有効にミサイルを発射したときの本人補助報酬、自機のミサイルで Red 機体を撃墜したときの本人補助報酬、自機が撃墜されたときの本人ペナルティを与えます。
